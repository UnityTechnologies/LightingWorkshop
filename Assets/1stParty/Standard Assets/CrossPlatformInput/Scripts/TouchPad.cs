...
namespace UnityStandardAssets.CrossPlatformInput
{
	...
	public class TouchPad : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
	{
        ...
        public Vector2 maxStickDeflection;
        public Vector2 minStickDeflection;
    ...
    private Image m_Image;
        ...
        void UpdateStickDisplay(Vector3 value)
        {
            if( stickGraphic == null )
            {
                return;
            }
            ...
            Vector3 stickOffsetThisFrame = new Vector3((value.x >= 0.0f ? maxStickDeflection.x : minStickDeflection.x), (value.y >= 0.0f ? maxStickDeflection.y : minStickDeflection.y), 0.0f);
            stickOffsetThisFrame.Scale(value);

            stickGraphic.localPosition = stickOffsetThisFrame;
        }
...
#endif
				Vector3 axisDelta = new Vector3 (pointerDelta.x, pointerDelta.y, 0);
				UpdateVirtualAxes(axisDelta);
				UpdateStickDisplay(axisDelta);
			}
		}
